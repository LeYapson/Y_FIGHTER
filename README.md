# Y_FIGHTER
name of the game:(Y_FIGHTER)

- type of game: 2D FIGHTING GAME WITH 2D PIXLE CHARACTERS AND 3D MAP
...
.décor:
*Japan inspiration map

.personnages:

*WHOIS (infomatics)  NEXT PATCH

*MAÏA (3d animation)

*WILLIAM (marketing) NEXT PATCH

*EMMA (creation)

*KAY (audiovisual) NEXT PATCH

*ALIX (architecture) NEXT PATCH


It's the first ever game that we make and we are a really little team (2 programmers and 4 3d animation) so we gonna take our time to create all the characters and we need to have a playable version of the game before the end of the school year. It's why we focus only 2 characters at once and work on only 1 map. 
